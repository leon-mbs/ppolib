...
class PPO
{
     ...
     * Подпись сообщения
     * 
     * @param mixed $message      сообщеие
     * @param Priv $key   приватный ключ
     * @param Cert $cert  сертификат
     * @return string   подписаное  и упакованое  в  контейнер  сообщение
     */
    ...
    /**
    * распаковка  подписаное  го  сообщения
    * 
    * @param mixed $message   сообщение
    * @param mixed $onlydata  не  проверять  подпись
    * @return mixed   данные сообщения
    */
